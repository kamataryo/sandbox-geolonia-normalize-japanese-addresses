(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var getTownRegexPatterns = function (pref, city) { return __awaiter(void 0, void 0, void 0, function () {
        var cachedResult, pre_towns, townSet, towns, _i, pre_towns_1, town, originalTown, townAbbr, patterns;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    var normalizeTownName = function (addr, pref, city) { return __awaiter(void 0, void 0, void 0, function () {
        var townPatterns, i, _a, _town, pattern, match;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    townPatterns = _b.sent();
                    for (i = 0; i < townPatterns.length; i++) {
                        _a = townPatterns[i], _town = _a[0], pattern = _a[1];
